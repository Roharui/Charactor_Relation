...
function writeRels()
{
    ch_rels.forEach(function(x){
        var start = indexCharactor(x.start)
        var target = indexCharactor(x.target)
        ...
        ctx.fillText(x.rel.name, (start.x + target.x) / 2, (start.y + target.y) / 2)
